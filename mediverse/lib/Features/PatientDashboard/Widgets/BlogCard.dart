...
//               ),
//               Padding(
//                 padding: const EdgeInsetsDirectional.fromSTEB(16, 20, 0, 4,),
//                 child: Row(
//                   mainAxisSize: MainAxisSize.max,
//                   children: [
//                     Expanded(
...
//                   height: image.isNotEmpty ? MediaQuery.of(context).size.width * 0.6 : 0,
//                   decoration: BoxDecoration(),
...
//                     Expanded(
//                       child: Text(
//                         '$date at ${time.substring(time.indexOf(' ') + 1)}',
