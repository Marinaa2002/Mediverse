...
//     if (validateAndSave() && sampleImage != null) {
...
//             children: <Widget>[
//               if (sampleImage != null)
//                 Image.file(sampleImage!, height: 200, width: 500,),
//               SizedBox(height: 5),
//               Align(
...
//                       _Profile = authorSnapshot.get('Profile_Picture') ?? 'default_profile_picture_url'; // Provide a default profile picture URL if null
//                       uploadBlog();
//                     } else {
//                       // Handle case when author snapshot does not exist
//                     }
//                   }
//                 },
...
class _BlogsAddState extends State<BlogsAdd> {
  ...
  Future<void> uploadBlog() async {
    if (validateAndSave()) {
      ...
      Navigator.pop(context);
      saveToDatabase(url ?? '', timeKey); // Pass the document name along with the URL
    }
  }
